...
GO
grant select,insert, update,delete on TEMPINV to public
GO
...
cast(a.CUSTNO as varchar) as CUSTNO,isnull(a.LNAME,'') as LNAME,isnull(a.FNAME,'') as FNAME,a.DEPT, isnull(a.PAYSUM,0) as PAYSUM, a.DUED
from dbo.TEMPINV a where PAYDATE is null and a.CREDIT =0 and a.CRERECNO is null
and a.RECACCNO is not null
...
select * from ASVIEW_CAREG_UNPAID_INVOICE

--- Repeat the below step for all sites
...
isnull(cast(a.ORDERNO as varchar),a.EXT_ORDERNO) as ORDNO,a.AMOUNTTOPAY,a.TOTPAID-ISNULL(a.CASHRETURNED,0) as TOTPAID,a.UPDATED_DATE as PAYDATE,
